...
export const CellAction: React.FC<CellActionProps> = ({ onDeleteApi, onUpdateApi }) => {
    ...
    <>
      <DropdownMenu modal={false}>
        ...
        <DropdownMenuContent className='flex justify-start items-start flex-col gap-2'>
          ...
          <DropdownMenuItem onClick={onDeleteApi} className='w-full h-6 rounded-sm text-slate-700 text-sm font-medium flex flex-row hover:bg-slate-100 cursor-pointer items-center'>
