...
const Login = () => {
  ...
  return (
    <div className='flex min-w-screen min-h-screen bg-neutral-100 justify-center items-center text-black'>
      <div className="w-[887px] h-[441px] px-[42px] py-[32px] bg-white text-black rounded-3xl shadow flex-row justify-center items-center gap-[38px] inline-flex">
        <div className=''>
        ...
        <div className='w-[418px] flex-col justify-center items-start inline-flex'>
          <form onSubmit={handleSubmit} className='w-full'>
            ...
            <div className='w-full flex-col justify-start items-start mb-4'>
              ...
              {emailError && <p className="text-red-500 text-sm font-normal pt-1 pl-1">{emailError}</p>}
            </div>
            <div className='w-full flex-col justify-start items-start mb-6'>
              ...
              {passwordError && <p className="text-red-500 text-sm font-normal pt-1 pl-1">{passwordError}</p>}
            </div>
